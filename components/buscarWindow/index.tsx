   ...
   <div className="pl-6 hidden pr-6 min-w-90 w-auto h-20 border-2 gap-2 lg:flex flex-row items-center
    ...
    {/** COMOBOBOX LOJAS CIDADES ESTADOS ------------------------------------------------------------- */}
     {(filtros.pagina === "Giro" || filtros.pagina === "Dashboard" || filtros.pagina === "Boletos" || filtros.pagina === "Compras") && (
            <div><h2 className='pl-1 text-sm pb-1 text-gray-700'>Loja, Cidade ou Estado:</h2>
            <div className="bg-black rounded-lg text-white">
              ...
              <Combobox
                ...
                >
                  ...
                  <ComboboxContent className='bg-black text-white'>
      ...
      {(filtros.pagina === "Giro" || filtros.pagina === "Dashboard" || filtros.pagina === "Compras" || filtros.pagina === "Contas" || filtros.pagina === "Boletos" || filtros.pagina === "Balancete") && (
            <div><h2 className='pl-1 text-sm pb-1 text-gray-700'>Período: </h2>
            <div className="bg-black rounded-lg text-white">
            ...
            <div className="flex items-center justify-center flex-row gap-7">
                <div>
                    <h3 className='text-sm pb-1 pl-1 text-gray-700'> Data Inicial</h3>
                ...
                <div>
                    <h3 className='text-sm pb-1 pl-1 text-gray-700'>Data Final</h3>
          ...
          {(filtros.pagina === "Giro" || filtros.pagina === "Estoque") && (
            <div><h2 className='pl-1 text-sm pb-1 text-gray-700'>Medida: </h2>
            <div className="bg-black rounded-lg text-white">
          ...
          <div className="bg-black flex flex-row justify-center items-center rounded-lg mt-6">
            
            <Button className="bg-black text-yellow-500" onClick={() => {   
            aplicarFiltro()
          }}
        >
          <Filter className="w-5 h-5 text-yellow-500"></Filter>Filtrar
        </Button>
        </div>
